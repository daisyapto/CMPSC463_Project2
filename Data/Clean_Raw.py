...
def preprocess_roads():
    roads = gpd.read_file("Data/Raw/Street_Centerline.geojson")
    roads = roads.to_crs(26918)
    roads.to_file("Data/Processed Data/Street_Centerline.geojson",
                  driver="GeoJSON")


def preprocess_floods():
    flood = gpd.read_file(
        "Data/Raw Data/420757_20250718 7.09.00 PM/S_FLD_HAZ_AR.shp")
    flood = flood.to_crs(26918)
    flood.to_file("Data/Processed Data/Floods.geojson", driver="GeoJSON")


def preprocess_evacuation_centers():
    facilities = gpd.read_file("Data/Raw Data/City_Facilities_pub.geojson")
    evac_keywords = [
        "Recreation Center",
        "Recreation Building",
        "Recreation Other",
    ...
    evac.to_file("Data/Processed Data/Facilities.geojson", driver="GeoJSON")


def preprocess_hurricanes():
    df = pd.read_csv("Data/Raw Data/ibtracs.NA.list.v04r01.csv",
    ...
    gdf_tracks.to_file("Data/Processed Data/Hurricanes.geojson", driver="GeoJSON")
